...
function WeappComponent(props: IWeapp): JSX.Element {
  ...
  return (
    <>
      <View
        className="antmui-minibar_left"
        style={{ top: `${paddingTop}px`, left: `${paddingLeft}px` }}
      >
        {backButton && (
          <View className="antmui-minibar_left_back" onClick={handleGoBack}>
            {buttonColor === 'black' ? (
              <Image
                className="antmui-minibar_left_back_bicon"
              ...
              <img
                className="antmui-minibar_left_back_icon"
                style={{ width: '32px', height: '32px' }}
                src={
        ...
        {homeButton && (
          <View className="antmui-minibar_left_home" onClick={handleGoHome}>
            {buttonColor === 'black' ? (
              <Image
                className="antmui-minibar_left_home_icon"
                style={{ width: '32px', height: '32px' }}
                src={
...
export default function Index(props: MiniBarProps): JSX.Element {
  ...
  const cls = `antmui-minibar ${
    fixed ? 'antmui-minibar_fixed' : ''
  } ${className}`
      ...
      {nav && (
        <>
          ...
          >
            ...
            <View
              className="antmui-minibar_center"
              style={{ paddingTop: `${nav.statusBarHeight as number}px` }}
            >
              {title}
            </View>
            {border && <View className="antmui-minibar_border" />}
          </View>
