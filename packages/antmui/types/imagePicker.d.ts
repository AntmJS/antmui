...
export interface ImagePickerProps extends ANTMUI.IBaseComponent {
  /**
   ...
   * 点击图片触发的回调
   */
  onImageClick?: (index: number, file: ANTMUI.IAnyObject) => void
  /**
   * 选择失败触发的回调
   */
...
declare const ImagePicker: ComponentClass<ImagePickerProps>
